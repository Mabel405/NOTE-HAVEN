<template>
  <div class="min-h-screen bg-[#0C0C0C] flex">
    ...
    <div class="hidden lg:flex flex-1 relative overflow-hidden items-center justify-center bg-[#080808] border-l border-white/5">
      ...
      <div class="relative text-center px-16">
        ...
        <p class="text-zinc-500 text-sm leading-relaxed max-w-sm mx-auto">
          Captura ideas, organiza pensamientos y accede a tus notas desde cualquier lugar.
        </p>
